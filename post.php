					...
					<div class="col-md-8">
						...
						<article class="article article-post">
							...
							<div class="article-main-img">
								<img src="asset/front/img/img-post.jpg" alt="">
							</div>
					...
					<div class="col-md-4">
						...
						<div class="widget">
							...
							<div id="owl-carousel-3" class="owl-carousel owl-theme center-owl-nav">
								...
								<article class="article">
									<div class="article-img">
										<a href="#">
											<img src="asset/front/img/img-md-3.jpg" alt="">
										</a>
										<ul class="article-info">
											<li class="article-type"><i class="fa fa-file-text"></i></li>
										</ul>
								...
								<article class="article">
									<div class="article-img">
										<a href="#">
											<img src="asset/front/img/img-md-4.jpg" alt="">
										</a>
										<ul class="article-info">
											<li class="article-type"><i class="fa fa-file-text"></i></li>
										</ul>
							...
							<article class="article widget-article">
								<div class="article-img">
									<a href="#">
										<img src="asset/front/img/img-widget-1.jpg" alt="">
									</a>
								</div>
								<div class="article-body">
									<h4 class="article-title"><a href="#">Duis urbanitas eam in, tempor consequat.</a></h4>
							...
							<article class="article widget-article">
								<div class="article-img">
									<a href="#">
										<img src="asset/front/img/img-widget-2.jpg" alt="">
									</a>
								</div>
								<div class="article-body">
									<h4 class="article-title"><a href="#">Duis urbanitas eam in, tempor consequat.</a></h4>
							...
							<article class="article widget-article">
								<div class="article-img">
									<a href="#">
										<img src="asset/front/img/img-widget-3.jpg" alt="">
									</a>
								</div>
								<div class="article-body">
									<h4 class="article-title"><a href="#">Duis urbanitas eam in, tempor consequat.</a></h4>
						...
						<div class="widget">
							...
							<div id="owl-carousel-4" class="owl-carousel owl-theme">
								...
								<article class="article thumb-article">
									<div class="article-img">
										<img src="asset/front/img/img-thumb-1.jpg" alt="">
									</div>
									<div class="article-body">
										<ul class="article-info">
											<li class="article-category"><a href="#">News</a></li>
								...
								<article class="article thumb-article">
									<div class="article-img">
										<img src="asset/front/img/img-thumb-2.jpg" alt="">
									</div>
									<div class="article-body">
										<ul class="article-info">
											<li class="article-category"><a href="#">News</a></li>
						...
						<div class="row">
							...
							<div class="col-md-3 col-sm-6">
								...
								<article class="article">
									<div class="article-img">
										<a href="#">
											<img src="asset/front/img/img-md-1.jpg" alt="">
										</a>
										<ul class="article-info">
							...
							<div class="col-md-3 col-sm-6">
								...
								<article class="article">
									<div class="article-img">
										<a href="#">
											<img src="asset/front/img/img-md-2.jpg" alt="">
										</a>
									</div>
									<div class="article-body">
										<h4 class="article-title"><a href="#">Duis urbanitas eam in, tempor consequat.</a></h4>
